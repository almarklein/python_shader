...
HASHES = {
    "test_if1.compute_shader": ("d6c9f62474e0776a", "adb5d6b1bf632f3b"),
    "test_if2.compute_shader": ("d1963f44053cdf57", "b3c995280b03495a"),
    "test_if3.compute_shader": ("4c479a73bd51d6a5", "51cdba50657612cc"),
    "test_if4.compute_shader": ("a14d264650efc4aa", "27b5808075c75e99"),
    "test_if5.compute_shader": ("6580a0c2925a3c32", "ba6975c0035ad235"),
    "test_ternary1.compute_shader": ("b266fa4c88d525a6", "7f62f3f37127f619"),
    "test_ternary2.compute_shader": ("380cd18e0bb5561b", "45ccfdde95ea2367"),
    "test_ternary3.compute_shader": ("beb18e4537da2d1e", "47564a4b3f8aea0a"),
    "test_andor2.compute_shader": ("4699d5363e68ee43", "baa80572e15b45f2"),
    "test_andor3.compute_shader": ("dc9792180f64e4d6", "cd97d599976985ac"),
    "test_andor4.compute_shader": ("7ac7659b99d46bf2", "4923fbf348289d9c"),
    "test_andor5.compute_shader": ("2b89ef239f94f2bb", "08ced40662f90a82"),
    "test_loop0.compute_shader": ("27ae7c5792fadb56", "f6f98af78a68499a"),
    "test_loop0b.compute_shader": ("c20a70d1d0085ad8", "f843a91a8b25b599"),
    "test_loop1.compute_shader": ("870628bb80aa8e59", "5fb17ea48db5478a"),
    "test_loop2.compute_shader": ("5f690a0cc6b4b81c", "2500775d8178172d"),
    "test_loop3.compute_shader": ("0b48077b4ca88ed7", "7a8de3dea5455a92"),
    "test_loop4.compute_shader": ("997b9f2f714b71c4", "65089c6f5a1ce395"),
    "test_loop5a.compute_shader": ("578f234b5e846c83", "bb309d0d730ef5ff"),
    "test_loop5b.compute_shader": ("90b206631325b506", "d15d6fca35bc49d6"),
    "test_loop6.compute_shader": ("64572152432c0035", "2572ad8ec9bcd4ae"),
    "test_loop7.compute_shader": ("3e3b04982779d035", "fd6d1adce103254a"),
    "test_loop8.compute_shader": ("14e2726965e33c3f", "cedb0ac5cae9c791"),
    "test_while1.compute_shader": ("8ac71a27e3fb45de", "e5fc96a0024a0d66"),
    "test_while2a.compute_shader": ("18923512cd5d689b", "8eeb591e514bc146"),
    "test_while2b.compute_shader": ("ca25131034a7dace", "f4295436a61f44e7"),
    "test_while2c.compute_shader": ("16bf0bfa0d6318bb", "ef8396e0804520cd"),
    "test_while3.compute_shader": ("439d1851302d978d", "f2130687438bed56"),
    "test_while4.compute_shader": ("a6945da8caec1a89", "7c231e7417179c5b"),
    "test_while5.compute_shader": ("cc26a0617c46aad0", "9a9046f2bf109d87"),
    "test_while6.compute_shader": ("847ce5cb0d3e52d5", "b8d44e3a9bad11ed"),
    "test_discard.fragment_shader": ("c457fb700b255166", "180c09756c518323"),
    "test_long_bytecode.compute_shader": ("43ed16146c7f10a0", "846d6731b4864cf9"),
}
